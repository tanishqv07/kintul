...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-orange-400 flex flex-col">
      <TitleBar />
      <Navbar setIsNavbarBottom={setIsNavbarBottom} />

      {/* Scrollable Content */}
      <div className="flex-grow overflow-y-auto p-6 pb-24 flex flex-col items-center">
        <h2 className="text-3xl font-bold text-center text-white mt-4 pb-1">
          My Profile
        </h2>
          ...
          <div className="bg-gray-900 p-6 shadow-xl shadow-orange-500 rounded-lg flex flex-col md:flex-row items-center md:items-start max-w-4xl w-full">
            ...
            <div className="flex justify-center w-full md:w-1/2 mb-4 md:mb-0">
              <img
                ...
                alt="Profile"
                className={` ${
                  isNavbarBottom ? "rounded-full w-40 h-40 border-2 border-white" : "rounded-none h-36 w-3/4"
